      ...
      <div className="w-[1000px] mx-auto">
        ...
        <div className="bg-white border-2 rounded-lg shadow-sm">
          ...
          <div className="border-b border-gray-200 p-3 flex justify-between items-center">
            <h1 className="text-2xl">Tra cứu bệnh nhân</h1>
            ...
            <div className="grid grid-cols-5 gap-2 mb-1">
              ...
              <div>
                ...
                <input
                    type="text"
                    placeholder="< Có chứa >"
                    className="w-full px-2 py-1 text-center placeholder:text-center border border-gray-300 rounded-md cursor-not-allow"
                  />
              </div>
