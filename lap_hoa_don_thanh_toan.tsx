              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    placeholder=""
                    className="w-full px-2 py-1 bg-gray-100 border border-gray-300 rounded-md pr-10 cursor-not-allowed"
                    readOnly
                  />
              
                  <div className="absolute top-0 right-0 w-10 h-full bg-gray-100 border border-gray-300 flex items-center justify-center rounded-r-md">
